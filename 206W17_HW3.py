...
## Any names of people you worked with on this assignment: Chalse Okorom

#####################
new_file = open("computer_paths.txt", "r", encoding = "utf-8")
